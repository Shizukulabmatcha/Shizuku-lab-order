...
function applyOrderingTheme(name) {
  ...
  Object.assign(astate.settingsDraft, {ordering_theme:name,theme_heading_font:theme.heading,theme_body_font:theme.body,default_menu_view:theme.menu});
  render();
}

function applyAdminTheme(name) {
  Object.assign(astate.settingsDraft, {admin_theme:name});
  render();
}
