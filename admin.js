...
function newMenuItem() {
  ...
  astate.editing = { id: null, enabled_option_group_ids: [], group_id: firstGroup?.id || null, category: firstGroup?.name || "Signature", name: "", description: "", price: 0, discount_price: null, image_url: "", is_available: true, show_price_on_menu: true, is_bundle: false, bundle_product_ids: [], bundle_pricing_mode: "fixed", bundle_selection_count: 2, bundle_option_prices: {}, bundle_show_choice_prices: false, bundle_display_from_price: null, stock: 0, sort_order: astate.menu.length + 1 };
  render();
}
...
function onEditField(key, value) {
  ...
  else if (key === "bundle_display_from_price") astate.editing[key] = value === "" ? null : Math.max(0, Number(value || 0));
