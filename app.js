  ...
  return `
    ...
    <div class="screen">
      ...
      <div class="field"><label>Collection date</label>
        <select style="width:100%;min-height:56px;padding:10px 14px;border-radius:12px;border:1px solid var(--line);background:#fff;color:var(--ink);font:inherit;font-size:16px;" onchange="onPickupDateChange(this.value)">
      ...
      <div class="field"><label>Collection time</label>
        <select style="width:100%;min-height:56px;padding:10px 14px;border-radius:12px;border:1px solid var(--line);background:#fff;color:var(--ink);font:inherit;font-size:16px;" ${f.pickupDate ? "" : "disabled"} onchange="onFormInput('slotId', this.value)">
